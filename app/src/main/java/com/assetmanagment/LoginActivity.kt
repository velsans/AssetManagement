...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    private fun mayRequestContacts(): Boolean {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS) && shouldShowRequestPermissionRationale(CAMERA)) {
            Snackbar.make(email, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
                .setAction(android.R.string.ok, {
                    requestPermissions(arrayOf(READ_CONTACTS, CAMERA), REQUEST_READ_CONTACTS)
                })
        } else {
            requestPermissions(arrayOf(READ_CONTACTS, CAMERA), REQUEST_READ_CONTACTS)
        }
        ...
        override fun onPostExecute(success: Boolean?) {
            ...
            if (success!!) {
                if (mPassword.equals("admin")) {
                    intent = Intent(applicationContext, AssetItems::class.java)
                    startActivity(intent)
                } else {
                    intent = Intent(applicationContext, QrScaningItem::class.java)
                    startActivity(intent)
                }
    ...
    companion object {
        ...
        private val DUMMY_CREDENTIALS = arrayOf("admin@gmail.com:admin", "users@gmail.com:users")
    }
}
